                    ...
                    <div class="col-md-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                if ($formation) {
                                ?>
                                    <form action="handle_edit_course.php" method="POST">
                                        <input type="hidden" name="id" value="<?php echo htmlspecialchars($formation['id']); ?>">
                                        <div class="form-group">
                                            <label for="nom_formation">Course Name</label>
                                            <input type="text" class="form-control" id="nom_formation" name="nom_formation" value="<?php echo htmlspecialchars($formation['nom_formation']); ?>" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="prix" name="prix" value="<?php echo htmlspecialchars($formation['prix']); ?>" step="0.01" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="type">Type</label>
                                            <input type="text" class="form-control" id="type" name="type" value="<?php echo htmlspecialchars($formation['type']); ?>" required>
                                        </div>
                                        <button type="submit" class="btn btn-primary mr-2">Update Course</button>
