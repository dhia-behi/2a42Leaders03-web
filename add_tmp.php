...
<div id="removeNotificationModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
    ...
    <script>
        function validateForm() {
            let isValid = true;
            const courseName = document.getElementById('nom_formation').value.trim();
            const description = document.getElementById('description').value.trim();
            const price = parseFloat(document.getElementById('prix').value.trim());
            const type = document.getElementById('type').value.trim();

            if (!courseName || !description || isNaN(price) || price <= 0 || !type) {
                alert('Please fill out all fields correctly. Price must be a positive number.');
                isValid = false;
            }
            return isValid;
        }
...
<body>
    <div class="container mt-5">
        <form class="forms-sample" action="handle_add_course.php" method="POST" id="courseForm" onsubmit="return validateForm();">
            <div class="form-group">
                <label for="nom_formation">Course Name:</label>
                <input type="text" class="form-control" id="nom_formation" name="nom_formation" placeholder="Enter or speak course name" required>
                <button type="button" class="btn btn-info" onclick="startDictation('nom_formation')">Speak</button>
            </div>
            <div class="form-group">
                <label for="description">Description:</label>
                <textarea class="form-control" id="description" name="description" rows="4" placeholder="Enter or speak description" required></textarea>
                <button type="button" class="btn btn-info" onclick="startDictation('description')">Speak</button>
            </div>
            <div class="form-group">
                <label for="prix">Price:</label>
                <input type="number" class="form-control" id="prix" name="prix" step="0.01" placeholder="Enter or speak price" required>
                <button type="button" class="btn btn-info" onclick="startDictation('prix')">Speak</button>
            </div>
            <div class="form-group">
                <label for="type">Type:</label>
                <input type="text" class="form-control" id="type" name="type" placeholder="Enter or speak type" required>
                <button type="button" class="btn btn-info" onclick="startDictation('type')">Speak</button>
            </div>
        ...
        <button href="./list_courses" class="btn btn-light">showlist</button>
    </div>
</body>
            <!-- End Page-content -->
    ...
    <script>
        ...
        function validateForm() {
            let nom = document.getElementById('nom_formation').value;
            ...
            if (!isNaN(description)) {
                alert("Description must be text.");
                return false;
            }

            if (!isNaN(type)) {
                alert("Type must be text.");
                return false;
            }
