...
<div id="removeNotificationModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
                ...
                <div class="col-12">
                    ...
                    if (!empty($formations)) {
                        ...
                        foreach ($formations as $formation) {
                            ...
                            echo "<h4 class='card-title'>" . htmlspecialchars($formation['nom_formation']) . "</h4>";
                            echo "<p>" . htmlspecialchars($formation['description']) . "</p>";
                            echo "<p class='text-muted'>$" . number_format($formation['prix'], 2) . "</p>";
                            echo "</div>";
                            echo "</div>";
                            echo "</div>";
                        }
        ...
        <!-- Your footer content here, similar to the admin dashboard -->
    </div>
    <!-- main-panel ends -->
</div>
            <!-- End Page-content -->
