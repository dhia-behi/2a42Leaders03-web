...
$typesOffre1 = $typeOffreC->afficherTypesOffre();
...
<body>
            ...
            <div class="card-body">
              <form novalidate="">
                ...
                <div class="mb-3 form-group">
                  ...
                  <div class="controls">
                    <input type="text" name="logo" class="form-control" required="" data-validation-required-message="This field is required" aria-invalid="false">
                  <div class="help-block"></div></div>
                </div>
  ...
  <tbody>
    <?php foreach ($typesOffre1 as $typeOffre) { ?>
    <tr>
      <td><?= $typeOffre['id'] ?></td>
      <td><?= $typeOffre['nom'] ?></td>
      <td><?= $typeOffre['description'] ?></td>
      <td>image.png</td>
      <td>
        <a href="supprimerTypeOffre.php?id=<?= $typeOffre['id'] ?>" class="btn btn-danger btn-sm">Supprimer</a>
      </td>
      <td>hhh</td>
    </tr>
    <?php } ?>
