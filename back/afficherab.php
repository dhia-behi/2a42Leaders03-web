...
<!-- Mirrored from themesbrand.com/velzon/html/default/forms-elements.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 16:06:29 GMT -->
<head>
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">Rima Jengani</span>
                                <span class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">Gestion Utilisateur</span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="http://localhost/userlist/view/afficher.php">Back to interface</a>
                            <a class="nav-link menu-link" href="#sidebarDashboards1" data-bs-toggle="collapse" role="button"
                               aria-expanded="false" aria-controls="sidebarDashboards1">
                                <i class="ri-notification-2-line"></i> <span data-key="t-dashboards">User</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarDashboards1">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="afficherab.php" class="nav-link" data-key="t-crm">Display User</a>
                                    </li>
...
<!--                         <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarDashboards2" data-bs-toggle="collapse" role="button"
                               aria-expanded="false" aria-controls="sidebarDashboards2">
                                <i class="ri-bubble-chart-fill"></i> <span data-key="t-dashboards">Type de Forum</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarDashboards2">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="AjouterType.php" class="nav-link" data-key="t-analytics"> Ajouter Type de Forum
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="AfficherType.php" class="nav-link" data-key="t-crm"> Afficher Type de Forum</a>
                                    </li>
...
-->
                               ...
                               <br>
                                        <div class="table-responsive" id="det">
                                                <table class="table table-borderless align-middle table-nowrap mb-0">
                                                    <thead>
                                                        <tr>
                                                            <th scope="col"><a href="afficherad.php?trier=id"><i class="ri-sort-desc"></i> </a>ID</th>
                                                            <th scope="col"><a href="afficherad.php?trier=fullname"><i class="ri-sort-desc"></i> </a>FullName</th>
                                                            <th scope="col"><a href="afficherad.php?trier=username"><i class="ri-sort-desc"></i> </a>UserName</th>
                                                            <th scope="col"><a href="afficherad.php?trier=email"><i class="ri-sort-desc"></i> </a>E-mail</th>
                                                            <th scope="col"><a href="afficherad.php?trier=password"><i class="ri-sort-desc"></i> </a>PassWord</th>
                                                            <th scope="col"><a href="afficherad.php?trier=age"><i class="ri-sort-desc"></i> </a>Age</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
													<?php
                                                        ...
                                                        <td><?PHP echo $row['id']; ?></td>
                                                            ...
                                                            <td>
                                                                <div class="hstack gap-3 fs-15">
                                                                    <a href="edit_ab.php?id=<?php echo $row['id'] ?>" class="link-primary"><i class="ri-settings-4-line"></i></a>
                                                                    <a href="supprimer_ab.php?id=<?php echo $row['id'] ?>" class="link-danger"><i class="ri-delete-bin-5-line"></i></a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <?php
                                    ...
                                    <nav aria-label="..." style="float: right;">
                                        <ul class="pagination">
                                            ...
                                            ?>
                                            <li class="page-item">
                                                <a class="page-link" href="AfficherRec.php?page=<?= $page-1; ?>" tabindex="-1">Previous</a>
                                            </li>
                                            <?php
                                            }else {
                                            ?>
    ...
    <script>
        ...
        function showCustomer(str) {
            ...
            xhttp.open("GET", "recherche.php?searchInput="+str, true);
            xhttp.send();
        }
    </script>
</body>
