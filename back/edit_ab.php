...
include "../model/userlist.php";
$rec = null;

$id = $_GET['id'];
$userC= new userlistC();
$currentuser = $userC->findusers($id);
                        ...
                        <form method="POST" name="f" onsubmit="return verif(this);">
                                    ...
                                    <div class="col-xxl-3 col-md-6 container">
										<div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <label for=""></label>
                                                    <input value="<?= $currentuser['fullname']?>" type="text" placeholder="Full Name" name="fullname" class="form-control">  
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                            <label for=""></label>
                                                    <input value="<?= $currentuser['username']?>" type="text" placeholder="UserName" name="username" class="form-control">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                            <label for=""></label>
                                                     <input value="<?= $currentuser['email']?>" type="text" placeholder="E-mail" name="email" class="form-control">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                            <label for=""></label>
                                                     <input value="<?= $currentuser['pass']?>" type="text" placeholder="PassWord" name="pass" class="form-control">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <label for=""></label>
                                                     <input value="<?= $currentuser['age']?>" type="text" placeholder="Age" name="age" class="form-control"> 
                                                </div>
                                            </div>
                                            <br><br>
                                        </div>
                            ...
                            <div class="row gy-4">
                                <div class="col-xxl-3 col-md-6">
                                    <button type="submit" name="modifier" class="btn btn-outline-success waves-effect waves-light">Modifier</button>
                                </div>      
                                </div>
                            </div>
                        </form>
