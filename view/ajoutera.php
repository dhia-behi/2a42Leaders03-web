<?php 
    ...
    if(isset($_POST['categorie'])){
        ...
        $forum1 =  new forum($_POST['categorie'],$_POST['titre'],$_POST['message'],$_POST['image'],$_POST['date'],$_POST['rate']=0);
        $r=new forumC();
						...
						<div class="banner-content col-lg-12">
                            ...
                            <div class="col-lg-12">
									<div class="form-group">
										<label for=""></label>
									<input type="text" placeholder="Categorie" name="categorie" class="form-control" id="categorie">
									</div>
								</div>
								<div class="col-lg-12">
									<div class="form-group">
									<label for=""></label>
									<input type="text" placeholder="Titre" name="titre" class="form-control" id="titre">
									</div>
								</div>
								<div class="col-lg-12">
									<div class="form-group">
									<label for=""></label>
									<input type="text" placeholder="Message" name="message" class="form-control" id="message">
									</div>
								</div>
								<div class="col-lg-12">
									<div class="form-group">
									<label for=""></label>
									<input type="text" placeholder="Lien de l'image" name="image" class="form-control" id="image">
									</div>
								</div>
								<div class="col-lg-12">
									<div class="form-group">
								...
								<div class="col-lg-12">
									<div class="form-group mrb-0">
										<button type="submit" class="btn btn-primary mt-3">Ajouter Reclamation</button>
